        ...
        <section class="formConnexion">
            ...
            <form class="couleurFond">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ingredient5" aria-describedby="#">
                </div>
                <div class="mb-3">
                    <label for="ingredient6" class="form-label">Ingredient 6</label>
                    <input type="text" class="form-control" id="ingredient6" aria-describedby="#">
                </div>
                <div class="mb-3">
                    <label for="ingredient7" class="form-label">Ingredient 7</label>
                    <input type="text" class="form-control" id="ingredient7" aria-describedby="#">
                </div>
                <div class="mb-3">
                    <label for="ingredient8" class="form-label">Ingredient 8</label>
                    <input type="text" class="form-control" id="ingredient8" aria-describedby="#">
                </div>
                <div class="mb-3">
                    <label for="ingredient9" class="form-label">Ingredient 9</label>
                    <input type="text" class="form-control" id="ingredient9" aria-describedby="#">
                </div>
                <div class="mb-3">
                    <label for="ingredient10" class="form-label">Ingredient 10</label>
        ...
        <section class="formCorps">
            ...
            <form class="couleurFond">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="image 2" aria-describedby="#">
                </div>
            </form>
        </section>
    </main>
